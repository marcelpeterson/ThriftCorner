...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Transaction Initiated!</h1>
            <p class="text-gray-600">Share these confirmation links to complete the transaction</p>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
            <div class="flex items-center gap-4">
                ...
                @endif
                <div class="flex-1">
                    <h3 class="font-bold text-gray-900">{{ $transaction->item->name }}</h3>
                    <p class="text-sm text-gray-600">{{ $transaction->item->price_rupiah }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6 mb-8">
            ...
            <div class="border border-blue-200 rounded-lg p-6 bg-blue-50">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-900 mb-2">Your Confirmation Link (Seller)</h3>
                        <p class="text-sm text-gray-600 mb-3">Use this link to confirm you've handed over the item</p>
            ...
            <div class="border border-emerald-200 rounded-lg p-6 bg-emerald-50">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-900 mb-2">Buyer Confirmation Link</h3>
                        <p class="text-sm text-gray-600 mb-3">Share this link with the buyer to confirm they've received the item</p>
                        <div class="flex gap-2">
        ...
        <div class="flex gap-4">
            ...
            <form action="{{ route('transaction.cancel', $transaction->id) }}" method="POST" class="flex-1"
                ...
                @csrf
                <button type="submit" 
                        class="w-full px-6 py-3 bg-red-100 hover:bg-red-200 text-red-700 font-semibold rounded-lg transition-colors cursor-pointer">
                    Cancel Transaction
                </button>
            </form>
        </div>

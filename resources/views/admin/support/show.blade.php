                ...
                @if($submission->attachment_path)
                    <div class="mt-6">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            ...
                            @if($isImage)
                                <img src="{{ asset('storage/' . $submission->attachment_path) }}" alt="Attachment" class="max-w-full rounded-lg mb-3">
                            @endif

                            <a href="{{ asset('storage/' . $submission->attachment_path) }}" target="_blank" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">

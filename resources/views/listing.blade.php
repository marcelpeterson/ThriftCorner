                        ...
                        <div class="ml-3 sm:ml-4">
                            ...
                            @if($item->user->location)
                                <div class="flex items-center mt-1">
                                    <svg class="w-3 h-3 text-gray-500 mr-1 max-md:mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    </svg>
                                    <p class="text-xs text-gray-600">{{ $item->user->location }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        @if(auth()->id() === $item->user_id)
                            <div class="mt-4 pt-4 border-t border-gray-200 space-y-3">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('items.edit', $item->slug) }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-bold py-2.5 px-1 sm:py-3 sm:px-2 rounded-lg transition duration-150 ease-in-out shadow text-center text-xs sm:text-sm cursor-pointer">
                                        <div class="flex items-center justify-center">
                                            <svg class="w-3.5 sm:w-4 h-3.5 sm:h-4 mr-1 sm:mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                            <span class="whitespace-nowrap">Edit Listing</span>
                                        </div>
                                    </a>
                                    <button onclick="showDeletionRequestModal()" type="button" class="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 px-4 sm:py-3 sm:px-6 rounded-lg transition duration-150 ease-in-out shadow text-center text-xs sm:text-sm cursor-pointer">
                                        <div class="flex items-center justify-center">
                                            <svg class="w-3.5 sm:w-4 h-3.5 sm:h-4 mr-1 sm:mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">

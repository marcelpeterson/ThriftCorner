...
<div class="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between sm:gap-3 mb-1 sm:mb-3">
            ...
            <div class="bg-gray-50 rounded-lg max-md:mb-2">
                <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-4">Item Details</h3>

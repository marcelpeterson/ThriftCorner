...
<div class="max-w-7xl mx-auto">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Track all your premium listing purchases and promotions</p>
    </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <div class="md:hidden flex flex-wrap items-center gap-3 text-xs text-gray-600 mb-3">
